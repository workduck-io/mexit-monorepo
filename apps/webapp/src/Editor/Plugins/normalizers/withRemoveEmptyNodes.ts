import { getNodeString, isElement, PlateEditor, removeNodes, Value, WithPlatePlugin } from '@udecode/plate'
 ...
 */
export const withRemoveEmptyNodes = <V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>>(
  editor: E,
