...
function flatten(items: TreeItems, parentId: string = null, depth = 0): FlattenedItem[] {
...
export function buildTree(flattenedItems: FlattenedItem[]): TreeItems {
  const root: TreeItem = { id: 'root', children: [], data: { nodeId: 'root', path: 'root', namespace: 'root' } }
