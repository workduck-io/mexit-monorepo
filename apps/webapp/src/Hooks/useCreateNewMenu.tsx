...
import { defaultContent, generateSnippetId, isReservedNamespace, MIcon, ModalsType, useDataStore, useLayoutStore , useMetadataStore , useModalStore, userPreferenceStore as useUserPreferenceStore,useShareModalStore, useSnippetStore  } from '@mexit/core'
