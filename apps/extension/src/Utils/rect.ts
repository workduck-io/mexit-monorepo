...
var Rect = {
    ...
    translate(rect: { bottom: any; top: any; left: any; right: any; width: any; height: any; }, x: number, y: number) {
        if (x == null) { x = 0; }
        if (y == null) { y = 0; }
        return {
    ...
    // subtract(rect1: { left: number; top: number; right: number; bottom: number; }, rect2: { left: number; top: number; right: number; bottom: number; width: number; height: number; }) {
    ...
    intersects(rect1: { right: number; left: number; bottom: number; top: number; }, rect2: { left: number; right: number; top: number; bottom: number; }) {
    ...
    intersectsStrict(rect1: { right: number; left: number; bottom: number; top: number; }, rect2: { left: number; right: number; top: number; bottom: number; }) {
        return (rect1.right >= rect2.left) && (rect1.left <= rect2.right) &&
            (rect1.bottom >= rect2.top) && (rect1.top <= rect2.bottom);
    },

    equals(rect1: { [x: string]: any; }, rect2: { [x: string]: any; }) {
    ...
    intersect(rect1: { left: number; top: number; right: number; bottom: number; }, rect2: { left: number; top: number; right: number; bottom: number; }) {
