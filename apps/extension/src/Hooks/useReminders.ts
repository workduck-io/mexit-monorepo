    ...
    switch (action.type) {
      ...
      case 'todo':
        ...
        switch (action.todoAction) {
          case 'status':
            updateStatusOfTodo(action.value.nodeid, action.value.id, action.value.properties.status)
            break
          case 'priority':
            updatePriorityOfTodo(action.value.nodeid, action.value.id, action.value.properties.priority)
            break
          default:
            break
        }
